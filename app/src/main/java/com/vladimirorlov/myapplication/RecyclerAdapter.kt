...
class RecyclerAdapter(private val itemList: ArrayList<ClassSelector>, var onClassClick : (ClassSelector) -> Unit)
    : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {

    // var onClassClick : ((ClassSelector) -> unit)? = null
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.class_layout, parent, false)
